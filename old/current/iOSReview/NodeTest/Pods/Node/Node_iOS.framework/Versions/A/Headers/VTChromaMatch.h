...
/**
 ...
 @param reading The VTRGBCReading to use in the match
 */
+ (NSArray *) requestChromaMatchReadingUsingColorSet: (VTChromaMatchColorSet *)colorSet withDevice: (VTChromaDevice *)device withReading: (VTRGBCReading *)reading;
