...
#import "GiftListTableViewController.h"

@interface GiftListTableViewController ()
@end

@implementation GiftListTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSMutableArray *arr;
    arr = [self.giftArray objectAtIndex:indexPath.row];
